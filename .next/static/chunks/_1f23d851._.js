...
const OrderSummary = ({ totalPrice, items })=>{
    _s();
    const currency = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_CURRENCY_SYMBOL || 'KES';
    ...
    const handlePlaceOrder = async (e)=>{
        e.preventDefault();
        if (!selectedAddress) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please select an address before placing order");
        }
        if (!phoneNumber) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please enter your M-Pesa phone number");
        }
        // Call your backend API to trigger Daraja STK Push
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].promise(fetch("/api/mpesa/stkpush", {
                method: "POST",
                headers: {
...
_s(OrderSummary, "HvGvQwqjQI30GTk3kLDBCchKDlE=", false, function() {
    return [
